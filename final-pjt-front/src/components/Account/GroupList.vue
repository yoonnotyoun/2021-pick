<template>
  <div class="mt-4">
    <b-list-group>
      <b-list-group-item class="d-flex align-items-center" @click="setGroupFilterId('전체')">전체</b-list-group-item>
      <div v-for="(group, idx) in groups" :key="idx">
        <b-list-group-item class="d-flex align-items-center" @click="setGroupFilterId(group.id)">
          {{ group.name }}
