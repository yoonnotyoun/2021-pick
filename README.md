...
💌 배포 주소 **https://pickyourtaste.click/**
...
공식문서와 코드를 직접 테스트하며 정확한 이해를 기반으로 문제를 해결해나갔고, 확실히 성장했음을 느꼈습니다. 프로젝트를 처음 시작했던 날보다 마지막 날에 훨씬 빠르고 정확하게  코드를 작성하는 스스로의 모습을 볼 수 있었습니다.
